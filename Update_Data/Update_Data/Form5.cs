...
namespace Update_Data
{
    public partial class Form5 : Form
    {
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            this.cmbThanhPho.DataSource = dtThanhPho;
            this.cmbThanhPho.DisplayMember = "TenThanhPho";
            this.cmbThanhPho.ValueMember = "ThanhPho";
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            this.cmbThanhPho.SelectedValue =
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            if (Them)
            {
                try
                {
                    ...
                    this.cmbThanhPho.SelectedValue.ToString() +
            ...
            if (!Them)
            {
                try
                {
                    ...
                    this.cmbThanhPho.SelectedValue.ToString() + "', DienThoai = '" +
        ...
        private void cmbThanhPho_SelectedIndexChanged(object sender, EventArgs e)
        {
